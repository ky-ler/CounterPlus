...
namespace offsets {
	...
	namespace signatures {
		...
		constexpr ptrdiff_t dwEntityList = 0x4DFEECC;
		constexpr ptrdiff_t dwForceAttack = 0x322CD38;
		constexpr ptrdiff_t dwForceAttack2 = 0x322CD44;
		constexpr ptrdiff_t dwForceBackward = 0x322CD80;
		constexpr ptrdiff_t dwForceForward = 0x322CD74;
		constexpr ptrdiff_t dwForceJump = 0x52BAC28;
		constexpr ptrdiff_t dwForceLeft = 0x322CCF0;
		constexpr ptrdiff_t dwForceRight = 0x322CCFC;
		constexpr ptrdiff_t dwGameDir = 0x63AD80;
		constexpr ptrdiff_t dwGameRulesProxy = 0x532E434;
		constexpr ptrdiff_t dwGetAllClasses = 0xE0AF1C;
		constexpr ptrdiff_t dwGlobalVars = 0x59EE60;
		constexpr ptrdiff_t dwGlowObjectManager = 0x5359980;
		constexpr ptrdiff_t dwInput = 0x525C4A0;
		constexpr ptrdiff_t dwInterfaceLinkList = 0x99A434;
		constexpr ptrdiff_t dwLocalPlayer = 0xDE997C;
		constexpr ptrdiff_t dwMouseEnable = 0x5238100;
		constexpr ptrdiff_t dwMouseEnablePtr = 0x52380D0;
		constexpr ptrdiff_t dwPlayerResource = 0x322B070;
		constexpr ptrdiff_t dwRadarBase = 0x52359A4;
		constexpr ptrdiff_t dwSensitivity = 0xDEDB98;
		constexpr ptrdiff_t dwSensitivityPtr = 0xDEDB98;
		constexpr ptrdiff_t dwSetClanTag = 0x8DA80;
		constexpr ptrdiff_t dwViewMatrix = 0x4DEFD14;
		constexpr ptrdiff_t dwWeaponTable = 0x525D57C;
		constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
		constexpr ptrdiff_t dwYawPtr = 0xDED928;
		constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDF3398;
		constexpr ptrdiff_t dwbSendPackets = 0xDD2B2;
		constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA62C0;
		constexpr ptrdiff_t find_hud_element = 0x2944F370;
		constexpr ptrdiff_t force_update_spectator_glow = 0x3D898A;
		constexpr ptrdiff_t interface_engine_cvar = 0x3FA9C;
		constexpr ptrdiff_t is_c4_owner = 0x3E61A0;
		...
		constexpr ptrdiff_t m_pitchClassPtr = 0x5237FF8;
		constexpr ptrdiff_t m_yawClassPtr = 0xDED928;
		constexpr ptrdiff_t model_ambient_min = 0x5A1194;
		constexpr ptrdiff_t set_abs_angles = 0x1E6AC0;
		constexpr ptrdiff_t set_abs_origin = 0x1E6900;
	}
}
