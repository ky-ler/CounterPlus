...
void ImGui::ShowDemoWindow(bool* p_open)
{
...
#endif
            MenuItem("Metrics/Debugger", NULL, &show_app_metrics, has_debug_tools);
            MenuItem("Debug Log", NULL, &show_app_debug_log, has_debug_tools);
            MenuItem("Stack Tool", NULL, &show_app_stack_tool, has_debug_tools);
    ...
    if (CollapsingHeader("Help"))
    {
        ...
        BulletText("Read the FAQ at http://www.dearimgui.com/faq/");
...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (Combo(label, &style_idx, "Dark\0Light\0Classic\0"))
    {
        ...
        {
        case 0:
            StyleColorsDark(); break;
        case 1:
            StyleColorsLight(); break;
        case 2:
            StyleColorsClassic(); break;
        }
        return true;
    }
    return false;
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (BeginTabItem("Rendering"))
        {
            ...
            SameLine(); HelpMarker("Additional alpha multiplier for disabled items (multiply over current value of Alpha).");
            PopItemWidth();
